    ...
    <section className="py-12 sm:py-16 md:py-24 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="aspect-video w-full rounded-xl overflow-hidden shadow-2xl mb-6 sm:mb-8 animate-scale-in hover:scale-[1.02] transition-transform duration-500" style={{ animationDelay: "0.2s" }}>
            <iframe
          ...
          <div className="text-center">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-6 text-muted-foreground animate-fade-in px-2" style={{ animationDelay: "0.3s" }}>{address}</p>
